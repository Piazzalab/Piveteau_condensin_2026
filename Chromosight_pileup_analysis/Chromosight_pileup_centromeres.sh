...
centro="_Centromeres/_S288c_centro_coordinates.bed2d" #file containing the coordinates of the centromeres in bed2d format
cen2cen="_Centromeres/_S288c_centro_chr7_others_coordinates.bed2d" #file containing the intersection of CEN7 with other centromeres in bed2d format

sample=("AD629_S288c_DSB_chr3_rDNA_cutsite_q20" "AD630_S288c_DSB_chr3_rDNA_cutsite_q20") #specify the cooler file name. The names must be followed by the "_1kb.cool" suffix. do not include it here
